...
class Branch(Base):
    ...
    streams: Mapped[List["Stream"]] = relationship("Stream", back_populates="branch", cascade="all, delete-orphan")
...
class Stream(Base):
    ...
    name: Mapped[str] = mapped_column(String(100), nullable=False)  # e.g., 'Core', 'AI-ML Specialization', 'Physics Group'
    code: Mapped[str] = mapped_column(String(20), nullable=False)

    branch: Mapped["Branch"] = relationship("Branch", back_populates="streams")
...
class Subject(Base):
    ...
    code: Mapped[str] = mapped_column(String(30), nullable=False)  # e.g., '21CS32'
